...
/* from https://stackoverflow.com/questions/16647819/time-cross-platform */
time_t 
time(struct tm const* t) /* does not modify broken-down time */
{
