...
#define CONFIG_MMS_MAXIMUM_PDU_SIZE 10000
...
#define CONFIG_TCP_KEEPALIVE_INTERVAL 5//2

/* number of not missing keepalive responses until socket is considered dead */
#define CONFIG_TCP_KEEPALIVE_CNT 3//2
...
#define CONFIG_ETHERNET_INTERFACE_ID "2"
...
#define CONFIG_REPORTING_DEFAULT_REPORT_BUFFER_SIZE 20000
