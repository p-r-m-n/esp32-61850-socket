...
static int sock_srv[CONFIG_LWIP_MAX_SOCKETS - 1];
static const size_t max_socks = CONFIG_LWIP_MAX_SOCKETS - 1;
...
void app_main(void)
{
    ...
    IedServer_setServerIdentity(iedServer, "UFPE", "esp32_61850_sub", "1.5.1");
    ...
    uint8_t dstMac[6] = {0xc4,0xde,0xe2,0xda,0x09,0xe7};
